...
describe('calendarService', () => {
    describe('polling for events', () => {
        let calendarGetResults: any[];
        let calendarService: any;
        let getCalendarSpy: jest.SpiedFunction<any>;
         ...
         * @private
         * @returns Resolves when the {@code calendarService} fires
         * an event with the passed in event name.
         */
        function createOneTimeCalendarServiceListener(eventName: string): Promise<any> {
        ...
        beforeEach(() => {
            ...
            getCalendarSpy = jest.spyOn(backendCalendar, 'getCalendar')
                .mockImplementation(() => Promise.resolve(calendarGetResults)) as jest.SpiedFunction<any>;
        ...
        it('does not notify of old requests after multiple poll starts', () => {
            ...
            jest.spyOn(calendarService, 'getCalendar').mockImplementation((options: any) => {
            ...
            return firstEventsPromise
                .then(() => {
                    ...
                    calendarService.addListener(
                        SERVICE_UPDATES.EVENTS_UPDATED,
                        (result: any) => result.isPolling && pollingUpdateHappened());
