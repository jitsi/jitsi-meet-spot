...
export default class MicPreview extends React.PureComponent<IProps, IState> {
    ...
    _createPreviewTrack() {
        ...
        const setLoadingPromise = new Promise<void>(resolve =>
    ...
    _destroyPreviewTrack() {
        ...
        return new Promise<void>(resolve => this.setState({ micPreviewTrack: null }, resolve));
    }
     ...
     *
     * @param audioLevel - The new audio level for the track.
     * @private
     * @returns {void}
     */
    _updateAudioLevel(audioLevel: number) {
