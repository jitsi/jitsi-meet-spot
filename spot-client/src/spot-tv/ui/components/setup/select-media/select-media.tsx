...
/**
 * A selectable media device descriptor.
 */
interface Device {

    /**
     * The WebRTC device id for the device.
     */
    deviceId?: string;

    /**
     * The WebRTC label for the device. To be displayed in dropdowns.
     */
    label: string;

    /**
     * The value to be returned when the device is selected in a dropdown.
     */
    value: string;
}

/**
 * The props of {@code SelectMedia}.
 */
interface IProps {
    ...
    preferredScreenshareDongle?: string;
    preferredSpeaker?: string;
    t?: (key: string) => string;
}

/**
 * The state of {@code SelectMedia}.
 */
interface IState {
    cameras: Device[];
    mics: Device[];
    resolutions: Device[];
    saving: boolean;
    screenshareDongles: Device[];
    selectedCamera?: string;
    selectedMic?: string;
    selectedResolution?: string;
    selectedScreenshareDongle?: string;
    selectedSpeaker?: string;
    speakers: Device[];
}

/**
 * The default device-list portion of the component state.
 */
interface IDefaultDeviceListState {
    cameras: Device[];
    resolutions: Device[];
    mics: Device[];
    screenshareDongles: Device[];
...
class SelectMedia extends React.Component<IProps, IState> {
     ...
     * @returns {Object}
     */
    _getDefaultDeviceListState(): IDefaultDeviceListState {
        return {
            cameras: [],
            resolutions: [
                {
     ...
     *
     * @param devices - The list of Device instances to filter
     * through to remove the selected camera.
     * @param selectedCamera - The label of the camera which has been
     * currently chosen for use.
     * @returns {Array<Device>}
     */
    _getFilteredScreenshareDongles(devices: Device[], selectedCamera?: string): Device[] {
        return [
     ...
     *
     * @param label - The label of the selected device.
     * @private
     * @returns {void}
     */
    _onCameraChange(label: string) {
        this.setState({
            screenshareDongles: [
     ...
     *
     * @param devices - The list of MediaDeviceInfos instances
     * as provided by enumerateDevices.
     * @private
     * @returns {void}
     */
    _onDeviceListChange(devices: Array<{ deviceId: string; kind: string; label: string; }>) {
     ...
     * @returns {void}
     */
    _onResolutionChange(resolution: string) {
        this.setState({
     ...
     * @returns {void}
     */
    _onScreenshareChange(label: string) {
        this.setState({
    ...
    _onSubmit() {
        ...
        const showSavingStatePromise = new Promise<void>(resolve =>
