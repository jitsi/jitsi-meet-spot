...
/**
 * The props for {@code ExitVerification}.
 */
interface IProps {
    onCancel?: () => void;
...
/**
 * The state for {@code ExitVerification}.
 */
interface IState {
    exitPassword?: string;
 ...
 */
export class ExitVerification extends React.Component<IProps, IState> {
    _enteredPassword?: string;
    ...
    componentDidMount() {
        ...
        fetchExitPassword()
            .then((exitPassword: string | undefined) => {
                if (exitPassword) {
                    this.setState({
     ...
     *
     * @param event - The input changed event object.
     * @private
     * @returns {void}
     */
     ...
     * @returns {void}
     */
    _onPasswordSubmit(event: React.SyntheticEvent) {
