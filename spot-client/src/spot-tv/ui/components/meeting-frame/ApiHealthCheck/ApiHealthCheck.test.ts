...
describe('ApiHealthCheck', () => {
    let apiHealthCheck: ApiHealthCheck;

    let mockHealthCheckFunction: jest.Mock<() => Promise<any>>;
    ...
    beforeEach(() => {
        ...
        mockHealthCheckFunction = jest.fn<() => Promise<any>>().mockReturnValue(Promise.resolve());
