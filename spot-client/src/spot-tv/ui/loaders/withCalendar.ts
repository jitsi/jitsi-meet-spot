 ...
 * integrations.
 */
export class CalendarLoader extends AbstractLoader<IProps, IState> {
    /**
     ...
     * in calendar events.
     *
     * @param data - The update which includes new events.
     * @private
     * @returns {void}
     */
    _onEventsUpdated(data: any) {
        const {
            events,
            ...extras
        } = data;
     ...
     *
     * @param data - The update which includes the error.
     * @private
     * @returns {void}
     */
    _onEventsError(data: any) {
