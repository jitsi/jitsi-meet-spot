...
interface IProps {
    ...
    shareDomain?: string;
    t?: (key: string) => string;
    wiredScreenshareEnabled?: boolean;
    wirelessScreenshareEnabled?: boolean;
}

interface IState {
    displayWirelessInstructions: boolean;
    displayWiredInstructions: boolean;
}

/**
 * Displays information and prompts to start screensharing.
 */
export class ScreensharePicker extends React.Component<IProps, IState> {
    /**
     ...
     * @inheritdoc
     */
    static getDerivedStateFromProps(props: IProps): Partial<IState> | null {
    ...
    render() {
        return (
            <div
                className = 'nav screenshare-select screenshare-picker'
        ...
        return (
            <>
                ...
                <div className = 'options'>
                    <NavButton
                        className = 'screenshare start-wireless-screenshare'
        ...
        return (
            <>
                ...
                <div className = 'footer'>
                    <Button
                        appearance = 'subtle'
                        className = 'cta-button stop-share-button'
