...
const requestStateToEventSuffix: Record<string, string> = {
 ...
 * @param requestState - The current status of the async request.
 * @returns
 */
function addRequestStateSuffix(eventName: string, requestState: string): string {
 ...
 * @returns
 */
function isPendingAsyncAction(action: any): boolean {
 ...
 * @returns
 */
function _registerRCSListeners(): void {
