...
/**
 * The shape of a log handler registered with the service. Handlers receive
 * batched logs and may optionally support updating the device ID.
 */
interface LogHandler {
    send: (logs: Array<string>) => void;
...
export default class LoggingService {
     ...
     *
     * @param handler - The callback which should receive logs.
     * @returns {void}
     */
     ...
     *
     * @param deviceId - The new device ID to be used.
     * @returns {void}
     */
     ...
     *
     * @param handler - The callback to be de-registered.
     * @returns {void}
     */
     ...
     * given storeInterval.
     *
     * @param logs - The log statements with meta data. The
     * jitsi-meet-logger stores the objects as strings.
     * @returns {void}
     */
    storeLogs(logs: Array<string>) {
