...
describe('XmppConnection', () => {
    ...
    describe('convertXMLPresenceToObject', () => {
        it('transforms MUC presence into a js object', () => {
            ...
            const xmppConnection = new XmppConnection({ configuration: { bosh: '' } });
