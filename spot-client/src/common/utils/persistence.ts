...
export default {
     ...
     * manipulation.
     *
     * @param key - The key from which to retrieve data.
     * @returns
     */
    get(key: string): any {
     ...
     *
     * @param key - The key under which the data should be saved.
     ...
     *
     * @param key - The key for the data which should be removed.
     * @returns
     */
