 ...
 *
 * @param writeKey - The app key for sending data to a specified
 * source in Segment.
 * @private
 * @returns {void}
 */
function loadGlobalSegment(writeKey: string): void {
...
export default {
     ...
     * still being loaded.
     *
     * @param writeKey - The API key provided by Segment for sending
     ...
     *
     * @param userId - A specific user identifier to set on the current
     * instance of Segment.
     * @param traits - Additional details to associate with the current
     * user.
     * @returns {void}
     */
     ...
     *
     * @param event - The name of the current event.
    ...
    page(name: string, properties: any): void {
        (window as any).analytics.page(/* category */ undefined, name, properties);
    }
};
