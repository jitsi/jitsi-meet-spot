 ...
 */
export class Notifications extends React.PureComponent<IProps> {
    static defaultProps = {
        notifications: []
    };
     ...
     *
     * @param notifications - The notification which should
     * automatically be hidden after a timeout.
     * @private
     * @returns {void}
     */
    _setTimeoutForNewNotifications(notifications: any[]) {
