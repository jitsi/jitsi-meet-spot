 ...
 * @returns {Object}
 */
export function destroyConnection(): any {
    return {
 ...
 * @param screensharingType - Either 'wired' or 'wireless'.
 * @returns {Function}
 */
export function joinWithScreensharing(meetingName: string, screensharingType: string): any {
    return (dispatch: any) => {
        remoteControlClient
            .goToMeeting(
                meetingName,
 ...
 *
 * @param meetingName - The Jitsi meeting to join.
 * @param meetingDisplayName - An alternative display name for the
 * meeting, such as the event name on a calendar.
 * @returns {Function}
 */
export function joinScheduledMeeting(meetingName: string, meetingDisplayName?: string): any {
    return (dispatch: any) => createAsyncActionWithStates(
        dispatch,
 ...
 * @returns {Function}
 */
export function joinAdHocMeeting(meetingName: string): any {
    return (dispatch: any) => createAsyncActionWithStates(
        dispatch,
 ...
 *
 * @param meetingName - The meeting name that will be used for the call.
 * @param phoneNumber - The phone number to dialed into the meeting.
 * @returns {Function}
 */
export function dialOut(meetingName: string, phoneNumber: string): any {
    const options = {
        invites: [
            {
 ...
 *
 * @param skipFeedback - Whether or not to immediately leave the
 * meeting without prompting for meeting feedback.
 * @param onlyIfLonelyCall - If true, hangup will occur only if there
 * are no remote participants in the call.
 * @returns {Function}
 */
export function hangUp(skipFeedback = false, onlyIfLonelyCall = false): any {
    return (dispatch: any) => {
 ...
 *
 * @param isReconnectScheduled - Whether or not a reconnect will
 * happen soon.
 * @returns {Object}
 */
export function reconnectScheduleUpdate(isReconnectScheduled: boolean): any {
    return {
 ...
 *
 * @param tones - The tones to play.
 * @returns {Function}
 */
export function sendTouchTones(tones: string): any {
 ...
 *
 * @param mute - Whether to audio mute or audio unmute.
 * @returns {Function}
 */
export function setAudioMute(mute: boolean): any {
    return (dispatch: any) => createAsyncActionWithStates(
        dispatch,
 ...
 *
 * @param handRaised - Whether to raise or lower the hand.
 * @returns {Function}
 */
export function setRaiseHand(handRaised: boolean): any {
    return (dispatch: any) => createAsyncActionWithStates(
        dispatch,
 ...
 *
 * @param tileView - Whether to tile view should be displayed.
 * @returns {Function}
 */
export function setTileView(tileView: boolean): any {
    return (dispatch: any) => createAsyncActionWithStates(
        dispatch,
 ...
 *
 * @param whiteboardOpen - Whether the whiteboard should be shown or hidden.
 * @returns {Function}
 */
export function setWhiteboard(whiteboardOpen: boolean): any {
    return (dispatch: any) => createAsyncActionWithStates(
        dispatch,
 ...
 *
 * @param mute - Whether to video mute or video unmute.
 * @returns {Function}
 */
export function setVideoMute(mute: boolean): any {
    return (dispatch: any) => createAsyncActionWithStates(
        dispatch,
 ...
 * @returns {Function}
 */
export function startWiredScreensharing(): any {
    return (dispatch: any) => createAsyncActionWithStates(
        dispatch,
 ...
 * @returns {Function}
 */
export function startWirelessScreensharing(): any {
    return (dispatch: any) => createAsyncActionWithStates(
        dispatch,
 ...
 * @returns {Function}
 */
export function forceStopWirelessScreenshare(): any {
    return (dispatch: any) => {
 ...
 * @returns {Function}
 */
export function stopScreenshare(): any {
    return (dispatch: any) => createAsyncActionWithStates(
        dispatch,
 ...
 *
 * @param isSharing - Wheteher or not local wireless screenshare is
 * active.
 * @returns {Object}
 */
export function setLocalWirelessScreensharing(isSharing: boolean): any {
    return {
