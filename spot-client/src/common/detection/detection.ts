 ...
 * @returns {boolean}
 */
export function isAutoFocusSupported(): boolean {
    /**
 ...
 * @returns {boolean}
 */
export function isSpotControllerApp(): boolean {
 ...
 * @returns {boolean}
 */
function _hasReactNativeOnlyAttributes(): boolean {
 ...
 * @returns {boolean}
 */
function _isIOSWebView(): boolean {
 ...
 * @returns {boolean}
 */
export function isSupportedSpotTvBrowser(): boolean {
