...
export class App extends React.Component<IAppProps, IAppState> {
     ...
     *
     * @param cursorIsIdle - Whether or not the cursor is idle.
     * @private
     * @returns {void}
     */
    _onCursorIdleChange(cursorIsIdle: boolean) {
     ...
     *
     * @param event - The message event posted.
     * @returns {void}
     */
    _onPostMessage({ data }: MessageEvent) {
        try {
            ...
            if (messageData && messageType) {
                this.props.dispatch(apiMessageReceived(messageType, messageData));
            }
        } catch (error) {
            logger.warn(`Unknown message received: '${data}'`, error as Record<string, any>);
        }
    }
     ...
     *
     * @param View - The Spot-Remove view component to show.
     * @returns {ReactElement}
     */
    _renderSpotRemoteViewWithHelp(View: React.ComponentType<any>) {
        return (
            <div>
                <View />
                <FeedbackOpener />
     ...
     *
     * @param View - The child to display within the remote
     * control service loader.
     * @param name - The name associate with the view. Used for remotes
     * to identify what view the spot is showing.
     * @private
     * @returns {ReactComponent}
     */
    _renderSpotViewWithRemoteControl(View: React.ComponentType<any>, name: string) {
        return (
