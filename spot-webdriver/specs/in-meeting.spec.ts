...
describe('While in a meeting ', () => {
    ...
    it('can toggle audio mute', async (): Promise<void> => {
    ...
    it('can toggle raise hand', async (): Promise<void> => {
        const spotRemoteInMeetingPage = spotRemote.getInMeetingPage();
        const spotTVMeetingPage = spotTV.getMeetingPage();
    ...
    it('can toggle video mute', async (): Promise<void> => {
        const spotRemoteInMeetingPage = spotRemote.getInMeetingPage();
        const spotTVMeetingPage = spotTV.getMeetingPage();
    ...
    it('can toggle tile view', async (): Promise<void> => {
        const spotRemoteInMeetingPage = spotRemote.getInMeetingPage();
        const spotTVMeetingPage = spotTV.getMeetingPage();
    ...
    it('does not have volume control when Spot-TV is in a browser', async (): Promise<void> => {
