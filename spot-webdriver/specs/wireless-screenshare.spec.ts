...
xdescribe('A Spot-Remote can screenshare wirelessly', () => {
     ...
     *
     * @param isPickerExpected - Whether or not a screenshare picker
     * will display when starting wireless screensharing.
     * @private
     * @returns {void}
     */
    async function startScreenshareFromHome(isPickerExpected: boolean): Promise<void> {
     ...
     * @returns {void}
     */
    async function startScreenshareFromMeeting(isPickerExpected: boolean): Promise<void> {
        const remoteControlPage = spotRemote.getRemoteControlPage();
