...
import SpotUser from '../user/spot-user.js';
...
describe('The reconnect logic', () => {
     ...
     * signaling.
     *
     * @param spotUser - The Spot-TV or Spot-Remote instance which
     * should disconnect from signaling.
     * @returns {void}
     */
    async function disconnectFromCommunicationPlane(spotUser: SpotUser): Promise<void> {
