...
interface SetupProps {
    onCancel?: () => void;
    onSubmitEnteredUrl?: (url: string) => void;
}

interface SetupState {
    enteredRemoteControlUrl: string;
    errorLoadingConfig: boolean;
    loading: boolean;
...
export default class Setup extends React.Component<SetupProps, SetupState> {
     ...
     *
     * @param enteredRemoteControlUrl - The Spot-Remote url entered so
     * far.
     * @private
     * @returns {void}
     */
    _onEnteredUrlChange(enteredRemoteControlUrl: string) {
     ...
     */
    _onSubmitEnteredUrl() {
        const setLoading = new Promise<void>(resolve => {
            this.setState({
                errorLoadingConfig: false,
                loading: true
            }, resolve);
